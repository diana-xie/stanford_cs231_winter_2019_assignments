...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        z1 = X.dot(W1) + b1  # z1 - hidden layer 1
        a1 = np.maximum(0, z1)  # ReLu - activation layer 1
        z2 = a1.dot(W2) + b2  # z2 - hidden layer 2
              
        scores = z2  # these are scores = just the final hidden layer before transforming into class probabilities
